...
namespace SparkAuto.Pages.Users
{
    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            ApplicationUser = await _db.applicationUsers.FirstOrDefaultAsync(m => m.Id == id);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                var userInDb = await _db.applicationUsers.SingleOrDefaultAsync(u => u.Id == ApplicationUser.Id);
                if (userInDb == null)
                {
                    return NotFound();
                }
