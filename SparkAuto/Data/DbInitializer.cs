    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public async void Initialize()
        {
            ...
            _userManager.CreateAsync(new ApplicationUser
            {
                ...
                Name = "Mohammad Javad",
                EmailConfirmed = true,
                PhoneNumber = "989013968068",
            }, "Admin123*").GetAwaiter().GetResult();


            _userManager.AddToRoleAsync(_db
                .Users
                .FirstOrDefaultAsync(c => c.Email == "admin@gmail.com").GetAwaiter().GetResult(),
                SD.AdminEndUser).GetAwaiter().GetResult();
        }
    }
}
